...
namespace Offwind.Sowfa.Constant.Omega
{
    public sealed class OmegaHandler : FoamFileHandler
    {
        public OmegaHandler()
            : base("Omega", null, "constant", OmegaRes.Default)
        {
        }
        ...
        {
            var d = (Vertice) data;
            var t = new StringBuilder(OmegaRes.Template);
