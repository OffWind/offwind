...
do
   ...
   then
      ...
      #                                           xmin    xmax    ymin    ymax   zmin    zmax  orientation
       ./points.py vertices faces points index    -0.1     0.1     0.0  3000.0    0.0  1000.0           yz
      #./points.py vertices faces points index     0.0  3000.0  2999.9  3000.1    0.0  1000.0           xz
      #./points.py vertices faces points index     0.0  3000.0    -0.1     0.1    0.0  1000.0           xz
      #./points.py vertices faces points index     0.0  3000.0     0.0  3000.0 1000.0  1000.0           xy
