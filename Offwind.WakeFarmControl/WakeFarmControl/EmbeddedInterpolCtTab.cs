...
{
    public sealed class EmbeddedInterpolCtTab
    {
        private PersistentVariables _persistentCt = null;
        ...
        public void Interpolate(double Beta, double Lambda, ILArray<double> table2, ILArray<double> Betavec2, ILArray<double> Lambdavec2, out double Finalval)
        {
            ...
            Yvals = new double[,] { { _persistentCt.Table.GetValue(B1, L1), _persistentCt.Table.GetValue(B2, L1) },
